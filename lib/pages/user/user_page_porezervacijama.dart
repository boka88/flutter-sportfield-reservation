...
import './porezervacijama_tabela.dart';

class UserPagePorezervacijama extends StatefulWidget {
  final String juzer;
  final String pass;
  final int opera;
  final String clapre;
  ...
  @override
  _UserPagePorezervacijamaState createState() =>
      _UserPagePorezervacijamaState();
}

class _UserPagePorezervacijamaState extends State<UserPagePorezervacijama> {
  ...
  _onSelected() {
    var route = new MaterialPageRoute(
      builder: (BuildContext context) => PorezervacijamaTabela(
        danod: danod.text,
        dando: dando.text,
        juzer: widget.juzer,
        pass: widget.pass,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Pregled po rezervacijama: ' + '${widget.clapre}'),
      ),
      body: Container(
        child: Center(
          child: Column(
