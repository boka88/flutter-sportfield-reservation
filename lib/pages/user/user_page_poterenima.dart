...
import './poterenima_tabela.dart';

class UserPagePoterenima extends StatefulWidget {
  final String juzer;
  final String pass;
  final int opera;
  final String clapre;
  ...
  @override
  _UserPagePoterenimaState createState() => _UserPagePoterenimaState();
}

class _UserPagePoterenimaState extends State<UserPagePoterenima> {
  ...
  _onSelected() {
    var route = new MaterialPageRoute(
      builder: (BuildContext context) => PoterenimaTabela(
        danod: danod.text,
        dando: dando.text,
        juzer: widget.juzer,
        pass: widget.pass,
